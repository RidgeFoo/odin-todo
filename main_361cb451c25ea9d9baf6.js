...
module.exports = __webpack_require__.p + "264a5d912ef8cea0182e.png";
...
var ___HTML_LOADER_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(731), __webpack_require__.b);
// Module
var ___HTML_LOADER_REPLACEMENT_0___ = getUrl_default()(___HTML_LOADER_IMPORT_0___);
var code = "<!DOCTYPE html> <html lang=\"en\"> <head> <meta charset=\"UTF-8\"/> <title>GoDo</title> <link rel=\"shortcut icon\" href=\"" + ___HTML_LOADER_REPLACEMENT_0___ + "\" type=\"image/x-icon\"/> </head> <body></body> </html> ";
// Exports
...
;// CONCATENATED MODULE: ./src/scripts/app/storage.js
...
/* harmony default export */ const storage = ({ populateStorageWithDefaults });

;// CONCATENATED MODULE: ./src/scripts/app/default-values.js
...
function createLogo() {
  ...
  logoContainer.insertAdjacentHTML("beforeend", check_solid_namespaceObject);
...
function createAddTask() {
  ...
  tippy_esm(btnAddTask, { content: "Add Task", arrow: false });

  btnAddTask.innerHTML = plus_solid_namespaceObject;
...
;// CONCATENATED MODULE: ./src/images/inbox-solid.svg
const inbox_solid_namespaceObject = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 512 512\"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d=\"M447 56.25C443.5 42 430.7 31.1 416 31.1H96c-14.69 0-27.47 10-31.03 24.25L3.715 304.9C1.247 314.9 0 325.2 0 335.5v96.47c0 26.51 21.49 48 48 48h416c26.51 0 48-21.49 48-48v-96.47c0-10.32-1.247-20.6-3.715-30.61L447 56.25zM352 352H160L128 288H72.97L121 96h270l48.03 192H384L352 352z\"/></svg>";
;// CONCATENATED MODULE: ./src/images/calendar-day-solid.svg
const calendar_day_solid_namespaceObject = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 448 512\"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d=\"M160 32V64H288V32C288 14.33 302.3 0 320 0C337.7 0 352 14.33 352 32V64H400C426.5 64 448 85.49 448 112V160H0V112C0 85.49 21.49 64 48 64H96V32C96 14.33 110.3 0 128 0C145.7 0 160 14.33 160 32zM0 192H448V464C448 490.5 426.5 512 400 512H48C21.49 512 0 490.5 0 464V192zM80 256C71.16 256 64 263.2 64 272V368C64 376.8 71.16 384 80 384H176C184.8 384 192 376.8 192 368V272C192 263.2 184.8 256 176 256H80z\"/></svg>";
;// CONCATENATED MODULE: ./src/images/calendar-days-solid.svg
const calendar_days_solid_namespaceObject = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 448 512\"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d=\"M160 32V64H288V32C288 14.33 302.3 0 320 0C337.7 0 352 14.33 352 32V64H400C426.5 64 448 85.49 448 112V160H0V112C0 85.49 21.49 64 48 64H96V32C96 14.33 110.3 0 128 0C145.7 0 160 14.33 160 32zM0 192H448V464C448 490.5 426.5 512 400 512H48C21.49 512 0 490.5 0 464V192zM64 304C64 312.8 71.16 320 80 320H112C120.8 320 128 312.8 128 304V272C128 263.2 120.8 256 112 256H80C71.16 256 64 263.2 64 272V304zM192 304C192 312.8 199.2 320 208 320H240C248.8 320 256 312.8 256 304V272C256 263.2 248.8 256 240 256H208C199.2 256 192 263.2 192 272V304zM336 256C327.2 256 320 263.2 320 272V304C320 312.8 327.2 320 336 320H368C376.8 320 384 312.8 384 304V272C384 263.2 376.8 256 368 256H336zM64 432C64 440.8 71.16 448 80 448H112C120.8 448 128 440.8 128 432V400C128 391.2 120.8 384 112 384H80C71.16 384 64 391.2 64 400V432zM208 384C199.2 384 192 391.2 192 400V432C192 440.8 199.2 448 208 448H240C248.8 448 256 440.8 256 432V400C256 391.2 248.8 384 240 384H208zM320 432C320 440.8 327.2 448 336 448H368C376.8 448 384 440.8 384 432V400C384 391.2 376.8 384 368 384H336C327.2 384 320 391.2 320 400V432z\"/></svg>";
;// CONCATENATED MODULE: ./src/images/chevron-down-solid.svg
const chevron_down_solid_namespaceObject = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 448 512\"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d=\"M224 416c-8.188 0-16.38-3.125-22.62-9.375l-192-192c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L224 338.8l169.4-169.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-192 192C240.4 412.9 232.2 416 224 416z\"/></svg>";
;// CONCATENATED MODULE: ./src/images/chevron-right-solid.svg
const chevron_right_solid_namespaceObject = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 320 512\"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d=\"M96 480c-8.188 0-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L242.8 256L73.38 86.63c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l192 192c12.5 12.5 12.5 32.75 0 45.25l-192 192C112.4 476.9 104.2 480 96 480z\"/></svg>";
;// CONCATENATED MODULE: ./src/images/trash-can-solid.svg
const trash_can_solid_namespaceObject = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 448 512\"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d=\"M135.2 17.69C140.6 6.848 151.7 0 163.8 0H284.2C296.3 0 307.4 6.848 312.8 17.69L320 32H416C433.7 32 448 46.33 448 64C448 81.67 433.7 96 416 96H32C14.33 96 0 81.67 0 64C0 46.33 14.33 32 32 32H128L135.2 17.69zM31.1 128H416V448C416 483.3 387.3 512 352 512H95.1C60.65 512 31.1 483.3 31.1 448V128zM111.1 208V432C111.1 440.8 119.2 448 127.1 448C136.8 448 143.1 440.8 143.1 432V208C143.1 199.2 136.8 192 127.1 192C119.2 192 111.1 199.2 111.1 208zM207.1 208V432C207.1 440.8 215.2 448 223.1 448C232.8 448 240 440.8 240 432V208C240 199.2 232.8 192 223.1 192C215.2 192 207.1 199.2 207.1 208zM304 208V432C304 440.8 311.2 448 320 448C328.8 448 336 440.8 336 432V208C336 199.2 328.8 192 320 192C311.2 192 304 199.2 304 208z\"/></svg>";
;// CONCATENATED MODULE: ./src/scripts/ui/helpers.js
...
const quickFilters = [
  { name: "Inbox", svg: inbox_solid_namespaceObject, topic: "/filterByProject" },
  { name: "Today", svg: calendar_day_solid_namespaceObject, topic: "/filterByPeriod" },
  { name: "Upcoming", svg: calendar_days_solid_namespaceObject, topic: "/filterByPeriod" },
];
...
function createProjectElement(name) {
  const svg = getSvgElement(trash_can_solid_namespaceObject);
...
function createAddProjectButton() {
  ...
  btn.id = "add-project";
  btn.innerHTML = plus_solid_namespaceObject;
  btn.addEventListener("click", showModal);
  tippy_esm(btn, { content: "Add project", arrow: false });
  return btn;
}
...
function getDropDownChevron(isDisplayed) {
  ...
  const svg = isDisplayed ? chevron_down_solid_namespaceObject : chevron_right_solid_namespaceObject;
...
let modal_task_projectList; // used for the project drop down
let isEdit;
...
const buttons = [
  ...
  },
  {
    ...
    text: "Cancel",
    funcEventListener: () => modal_task_modal.close(),
  },
];
...
let modal_task_projectDropDown;
let modal_task_form;

const buttonContainer = createButtonContainer();
const modal_task_modal = createModal();
...
function getFormValidity() {
  return modal_task_form.checkValidity();
}
...
function updateProjectList(topic, projects) {
  modal_task_projectList = projects.sort();
}
...
function renderProjectDropDown(currentProject = null) {
  ...
  modal_task_projectList.forEach((project) =>
    select.appendChild(createProjectListOption(project, currentProject))
  );

  container.append(label, select);

  modal_task_projectDropDown = container;
}

function renderTaskPropertiesContainer() {
  const container = document.createElement("div");
  container.id = "modal-task-properties";
  container.append(inputDueDate, priorityDropDown, modal_task_projectDropDown);
  taskPropertiesContainer = container;
}

function renderForm() {
  modal_task_form = document.createElement("form");
  modal_task_form.setAttribute("method", "dialog");

  modal_task_form.addEventListener("submit", (event) => {
    event.preventDefault();
    if (getFormValidity()) {
      modal_task_sendFormData();
      modal_task_modal.close();
    }
  });
}
...
function renderInputs({ projectName, title, dueDate, priority }) {
  ...
  modal_task_form.append(inputTitle, taskPropertiesContainer, buttonContainer);
}

function modal_task_renderModal(taskObj) {
  renderForm();
  renderInputs(taskObj);
  clearChildElements(modal_task_modal);
  modal_task_modal.append(modal_task_form);
...
function modal_task_sendFormData() {
  const formData = Object.fromEntries(new FormData(modal_task_form));
  if (isEdit) {
...
;// CONCATENATED MODULE: ./src/images/circle-solid.svg
const circle_solid_namespaceObject = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 512 512\"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d=\"M512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256z\"/></svg>";
...
function createAddTaskButton() {
  ...
  button.insertAdjacentHTML("afterbegin", plus_solid_namespaceObject);
  button.append(label);
...
document
  .querySelector("body")
  .append(header, sidebar, tasks, modal_task, modal_project);
